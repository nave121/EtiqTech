...
| File | What |
|------|------|
| `statute-1994-he.txt` | **The statute**: חוק צער בעלי חיים (ניסויים בבעלי חיים), התשנ״ד–1994, consolidated (incl. the 2007 amendment), imported from Hebrew WikiSource by `scripts/import_statute.py`. The statute text carries no copyright (Israeli Copyright Act 2007, s. 6); WikiSource's markup layer is CC BY-SA. Source: https://he.wikisource.org/wiki/חוק_צער_בעלי_חיים_(ניסויים_בבעלי_חיים) |
