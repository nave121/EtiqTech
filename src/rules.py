...
RULES: Dict[str, Rule] = {r.id: r for r in [
    ...
    _r("permits:field-study", "law_critical", "IL-form", "Field study lists required permits"),
    # --- 3Rs, numbers, sex ---
    ...
    _r("cosmetics:ban", "law_critical", "IL-form", "No cosmetics / household-product testing"),
